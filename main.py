...
def get_response(prompt):
    response = openai.Completion.create(
        ...
        prompt = "The following is a conversation with an AI assistant in russian (using werbs like woman). The assistant is helpful, creative, clever, and very friendly.\nHuman: " + prompt + "\nAI: ",
        temperature = 0.8,
        max_tokens = 500,
        top_p = 1,
